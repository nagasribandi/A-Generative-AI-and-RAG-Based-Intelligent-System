...
function generateSampleComplaints() {
  ...
  return [
    ...
    },
    {
      ...
      description: 'There is a significant water leak from the pipe under the basin in the 2nd floor washroom. Water is pooling on the floor creating a slip hazard. This needs urgent attention.',
    ...
    },
    {
      ...
      location: 'Block 1 - Computer Lab 2',
      category: 'IT & Network',
    ...
    },
    {
      ...
      description: 'The classrooms in Block 3 have not been cleaned properly for several days. Dust has accumulated on the desks, projectors, and window sills. It is affecting students with allergies.',
      location: 'Block 3 - Ground Floor',
      category: 'Cleanliness',
      predictedCategory: 'Cleanliness',
      confidence: 87,
      priority: 'Low',
      status: 'In Progress',
      aiSummary: 'ℹ️ Cleanliness issue logged. Enhanced cleaning schedule has been assigned for Block 3.',
    ...
    },
    {
      ...
      title: 'Crack in the wall of Block 1 corridor',
      description: 'A large crack has appeared on the wall of Block 1 corridor near the staircase. It seems to be getting wider. The paint is also peeling around it.',
      location: 'Block 1 - 1st Floor',
