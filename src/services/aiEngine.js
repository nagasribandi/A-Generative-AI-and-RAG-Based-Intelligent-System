  ...
  return [
    {
      ...
      userEmail: 'rahul@student.edu',
      title: 'Broken ceiling fan in Lecture Hall 3',
      description: 'The ceiling fan in Lecture Hall 3 has been making a loud grinding noise for the past week and stopped working completely today. The hall becomes very hot during afternoon lectures.',
      location: 'Main Building - Lecture Hall 3',
      category: 'Electrical',
      predictedCategory: 'Electrical',
      confidence: 88,
      priority: 'Medium',
      status: 'In Progress',
      aiSummary: '📋 This electrical complaint requires standard response. The fan failure has been identified and maintenance team dispatched.',
      ragResponse: generateRAGResponse('Electrical'),
    ...
    },
    {
      ...
      userEmail: 'priya@student.edu',
      title: 'Water leaking from bathroom pipe',
      description: 'There is a significant water leak from the pipe under the basin in the 2nd floor girls washroom. Water is pooling on the floor creating a slip hazard. This needs urgent attention.',
      location: 'Science Block - 2nd Floor Washroom',
      category: 'Plumbing',
      predictedCategory: 'Plumbing',
      confidence: 92,
      priority: 'High',
      status: 'Open',
      aiSummary: '⚠️ URGENT: This plumbing issue requires immediate attention. Water leak creating safety hazard.',
      ragResponse: generateRAGResponse('Plumbing'),
    ...
    },
    {
      ...
      userId: 'admin-001',
      userName: 'Amit Kumar',
      userEmail: 'amit@student.edu',
      title: 'WiFi not working in Computer Lab',
      description: 'The WiFi connection in Computer Lab 2 has been extremely slow and intermittent for the past 3 days. Students are unable to access online resources during practical sessions.',
      location: 'IT Block - Computer Lab 2',
      category: 'IT & Network',
      predictedCategory: 'IT & Network',
      confidence: 95,
      priority: 'Medium',
      status: 'Open',
      aiSummary: '📋 This IT & Network complaint requires standard response. Network connectivity issues identified in lab area.',
      ragResponse: generateRAGResponse('IT & Network'),
    ...
    },
    {
      ...
      userEmail: 'sneha@student.edu',
      title: 'Broken chairs in Room 204',
      description: 'Several chairs in classroom 204 are broken with loose legs and torn seats. At least 8 chairs are in unusable condition forcing students to sit on the floor.',
      ...
      priority: 'Medium',
      status: 'Resolved',
      aiSummary: '📋 Furniture replacement completed. 8 chairs have been replaced in Room 204.',
      ragResponse: generateRAGResponse('Furniture'),
    ...
    },
    {
      ...
      userEmail: 'karthik@student.edu',
      title: 'Fire extinguisher expired in hostel block',
      description: 'The fire extinguisher on the 3rd floor of Boys Hostel Block A has expired. The last inspection date on the tag shows it was due for replacement 3 months ago. This is a serious safety hazard.',
      location: 'Boys Hostel - Block A, 3rd Floor',
      category: 'Safety & Security',
      predictedCategory: 'Safety & Security',
      confidence: 91,
      priority: 'High',
      status: 'Open',
      aiSummary: '⚠️ URGENT: Safety equipment non-compliance detected. Expired fire extinguisher poses significant risk.',
      ragResponse: generateRAGResponse('Safety & Security'),
      createdAt: new Date(now - 1 * 86400000).toISOString(),
      updatedAt: new Date(now - 1 * 86400000).toISOString()
    },
    {
      ...
      userId: 'admin-001',
      userName: 'Divya Iyer',
      userEmail: 'divya@student.edu',
      title: 'Dirty classrooms and dusty equipment',
      description: 'The classrooms in Block C have not been cleaned properly for several days. Dust has accumulated on the desks, projectors, and window sills. It is affecting students with allergies.',
      location: 'Block C - Multiple Classrooms',
      category: 'Cleanliness',
      predictedCategory: 'Cleanliness',
      confidence: 87,
      priority: 'Low',
      status: 'In Progress',
      aiSummary: 'ℹ️ Cleanliness issue logged. Enhanced cleaning schedule has been assigned for Block C.',
      ragResponse: generateRAGResponse('Cleanliness'),
    ...
    },
    {
      ...
      userId: 'admin-001',
      userName: 'Ravi Verma',
      userEmail: 'ravi@student.edu',
      title: 'Crack in the wall of main building corridor',
      description: 'A large crack has appeared on the wall of the main building corridor near the staircase. It seems to be getting wider. The paint is also peeling around it.',
      ...
      priority: 'High',
      status: 'In Progress',
      aiSummary: '⚠️ URGENT: Structural assessment required. Wall crack near staircase may indicate deeper infrastructure issues.',
      ragResponse: generateRAGResponse('Infrastructure'),
    ...
    },
    {
      ...
      userEmail: 'meera@student.edu',
      title: 'Hostel mess food quality issues',
      description: 'The food quality in the hostel mess has deteriorated significantly. Rice is often undercooked, vegetables are stale, and the menu is not being followed as per the notice board.',
      location: 'Girls Hostel - Mess Hall',
      category: 'Hostel',
      predictedCategory: 'Hostel',
      confidence: 89,
      priority: 'Medium',
      status: 'Open',
      aiSummary: '📋 Hostel mess complaint received. Food quality audit has been scheduled with mess committee.',
      ragResponse: generateRAGResponse('Hostel'),
      createdAt: new Date(now - 2 * 86400000).toISOString(),
      updatedAt: new Date(now - 2 * 86400000).toISOString()
    }
  ];
